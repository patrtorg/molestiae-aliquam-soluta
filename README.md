[![npm version](https://img.shields.io/npm/v/@patrtorg/molestiae-aliquam-soluta.svg)](https://www.npmjs.com/package/@patrtorg/molestiae-aliquam-soluta)
[![npm downloads](https://img.shields.io/npm/dm/@patrtorg/molestiae-aliquam-soluta.svg)](https://www.npmjs.com/package/@patrtorg/molestiae-aliquam-soluta)
[![Build Status](https://github.com/patrtorg/molestiae-aliquam-soluta/workflows/CI/badge.svg)](https://github.com/patrtorg/molestiae-aliquam-soluta/actions)
...
```
npm i @patrtorg/molestiae-aliquam-soluta
```

To use in an ESM file:

```js
import * as @patrtorg/molestiae-aliquam-soluta from "@patrtorg/molestiae-aliquam-soluta";

const ast = @patrtorg/molestiae-aliquam-soluta.parse(code);
```

To use in a Common JS file:

```js
const @patrtorg/molestiae-aliquam-soluta = require("@patrtorg/molestiae-aliquam-soluta");
...
```js
const ast = @patrtorg/molestiae-aliquam-soluta.parse('let foo = "bar"', { ecmaVersion: 6 });
console.log(ast);
```
...
const tokens = @patrtorg/molestiae-aliquam-soluta.tokenize('let foo = "bar"', { ecmaVersion: 6 });
console.log(tokens);
```
...
Returns the current `@patrtorg/molestiae-aliquam-soluta` version
...
Returns the latest ECMAScript supported by `@patrtorg/molestiae-aliquam-soluta`
...
Issues and pull requests will be triaged and responded to as quickly as possible. We operate under the [ESLint Contributor Guidelines](http://eslint.org/docs/developer-guide/contributing), so please be sure to read them before contributing. If you're not sure where to dig in, check out the [issues](https://github.com/patrtorg/molestiae-aliquam-soluta/issues).
